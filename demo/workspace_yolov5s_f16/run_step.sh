...
# opt top mlir.
../../build/bin/tpuc-opt yolov5s_origin_small.mlir --shape-infer --canonicalize --extra-optimize -o yolov5s.mlir
...
model_runner.py --input yolov5s_in_f32.npz --model yolov5s_bm1684x_f16_tpu.mlir --output yolov5s_bm1684x_f16_tpu_outputs.npz
npz_tool.py compare yolov5s_bm1684x_f16_tpu_outputs.npz yolov5s_top_outputs.npz --tolerance 0.99,0.90 --except - -vv
...
# codegen bmodel.
tpuc-opt yolov5s_bm1684x_f16_final.mlir --codegen="model_file=yolov5s_1684x_f16.bmodel embed_debug_info=False model_version=latest bmodel_only=False gdma_check=True" -o /dev/null

# check bmodel result.
model_runner.py --input yolov5s_in_f32.npz --model yolov5s_1684x_f16.bmodel --output yolov5s_bm1684x_f16_model_outputs.npz
npz_tool.py compare yolov5s_bm1684x_f16_model_outputs.npz yolov5s_bm1684x_f16_tpu_outputs.npz --tolerance 0.99,0.90 --except - -vv
